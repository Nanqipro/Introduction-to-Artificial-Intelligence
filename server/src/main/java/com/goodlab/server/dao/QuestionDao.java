...
public class QuestionDao {
         ...
         * 创建Question对象的辅助方法
         */
        private Question createQuestion(Long id, String chapterId, String type, String title, String description,
                        List<String> options, Object correctAnswer, Integer score, String explanation) {
                ...
                question.setCreateTime(java.time.LocalDateTime.now());
