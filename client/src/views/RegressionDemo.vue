<template>
  ...
  .side-panel {
    background: rgba(var(--secondary-color, #23272e), 0.92);
    border-radius: calc(var(--border-radius, 10px) * 1.5);
    ...
    align-items: stretch;
    border: 1.5px solid var(--border-color, rgba(57, 59, 64, 0.18));
    gap: 1.2em;
    height: fit-content;
    margin: 0 auto;
  ...
  .lang-switch button {
    background: none;
    border: none;
    color: var(--accent-color-light, #d1d3d8);
    font-size: 1.08em;
    font-weight: 700;
    cursor: pointer;
    padding: 0.2em 0.7em;
  ...
  .lang-switch button.active, .lang-switch button:hover {
    background: var(--primary-hover-color, #2c2e30);
    color: var(--text-color, #f5f6fa);
  ...
  .type-switch button {
    background: linear-gradient(90deg, var(--primary-color-light, #232526) 0%, var(--primary-hover-color, #2c2e30) 100%);
    color: var(--accent-color-light, #d1d3d8);
    border: none;
    border-radius: calc(var(--border-radius, 10px) * 1.1);
  ...
  .desc-card {
    background: rgba(var(--primary-color, #18191a), 0.85);
    border-radius: calc(var(--border-radius, 10px) * 1.1);
    box-shadow: var(--box-shadow, 0 4px 24px rgba(24, 25, 26, 0.10));
  ...
  .teaching-tips {
    background: rgba(var(--primary-hover-color, #2c2e30), 0.7);
    border-radius: var(--border-radius, 10px);
    color: var(--text-color, #f5f6fa);
    font-size: 1em;
    padding: 0.7em 1em;
  ...
  input[type="range"] {
    ...
    margin: 0 0.3em;
    height: 3px;
    background: var(--border-color, rgba(57, 59, 64, 0.18));
    border-radius: 2px;
  ...
  .chart-card {
    background: rgba(var(--secondary-color, #23272e), 0.92);
    border-radius: calc(var(--border-radius, 10px) * 1.2);
    box-shadow: var(--box-shadow, 0 4px 24px rgba(24, 25, 26, 0.10));
  ...
  .input-table input[type="number"] {
    ...
    color: var(--text-color, #f5f6fa);
    border: 1px solid var(--border-color, rgba(57, 59, 64, 0.18));
    border-radius: calc(var(--border-radius, 10px) * 0.7);
    padding: 0.2em 0.5em;
    font-size: 1em;
