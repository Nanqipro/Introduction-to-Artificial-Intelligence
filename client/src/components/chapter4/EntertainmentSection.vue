...
const entertainmentCases = ref([
  {
    ...
    name: '某短视频平台',
    category: '短视频',
    logo: '/src/assets/icons/short-video.svg',
    description: '基于AI算法的个性化短视频推荐平台，通过深度学习分析用户行为，实现精准内容分发。',
    fullDescription: '某知名短视频社交平台，通过先进的AI推荐算法，为用户提供个性化的内容体验。平台运用计算机视觉、自然语言处理等技术，实现内容理解和用户画像构建，让每个用户都能看到最感兴趣的内容。',
    users: '12亿+',
    accuracy: '85%',
    dailyActive: '6亿+',
    contentSize: '数十亿条视频',
  ...
  },
  {
    ...
    name: '某流媒体平台',
    category: '流媒体',
    logo: '/src/assets/icons/streaming-play.svg',
    description: '全球领先的流媒体平台，运用机器学习算法为用户推荐个性化影视内容。',
    fullDescription: '某知名流媒体平台是全球最大的流媒体娱乐服务公司，通过复杂的机器学习算法分析用户观看历史、评分、搜索行为等数据，为每个用户生成个性化的内容推荐。平台还利用AI技术优化内容制作和分发策略。',
    users: '2.3亿+',
    accuracy: '80%',
    dailyActive: '1.5亿+',
  ...
  },
  {
    ...
    name: '某音乐平台',
    category: '音乐',
    logo: '/src/assets/icons/music-play.svg',
    description: '智能音乐流媒体平台，通过AI分析音乐特征和用户偏好，创建个性化播放列表。',
    fullDescription: '某知名音乐流媒体平台，运用先进的音频分析和机器学习技术，深度理解音乐特征和用户喜好。平台能够分析音乐的节拍、调性、情绪等特征，结合用户的听歌历史，创建高度个性化的音乐体验。',
    users: '4.8亿+',
    accuracy: '78%',
    dailyActive: '2.2亿+',
    contentSize: '1亿+首歌曲',
  ...
  },
  {
    ...
    name: '某游戏平台',
    category: '游戏',
    logo: '/src/assets/icons/game.svg',
    description: '知名PC游戏平台，运用AI算法为玩家推荐合适的游戏内容。',
    fullDescription: '某知名游戏分发平台通过分析玩家的游戏历史、评价、愿望单等数据，运用机器学习算法为玩家推荐可能感兴趣的游戏。平台还利用AI技术进行反作弊检测和社区内容管理。',
    users: '1.3亿+',
    accuracy: '72%',
    dailyActive: '3000万+',
  ...
  {
    id: 'international-short-video',
    name: '某国际短视频平台',
    category: '短视频',
    logo: '/src/assets/icons/short-video.svg',
    description: '国际化短视频平台，通过先进的AI算法在全球范围内提供个性化短视频内容。',
    fullDescription: '某知名国际短视频平台，通过先进的AI技术，在全球范围内为用户提供个性化的短视频内容。平台运用多模态AI技术，理解视频、音频、文字等多种内容形式，实现跨文化的内容推荐。',
    users: '10亿+',
    accuracy: '83%',
    dailyActive: '5亿+',
    contentSize: '数十亿条视频',
  ...
  },
  {
    ...
    name: '某视频分享平台',
    category: '视频',
    logo: '/src/assets/icons/video-play.svg',
    description: '全球最大的视频分享平台，运用AI技术进行内容推荐和创作者支持。',
    fullDescription: '某知名视频分享平台，运用先进的机器学习技术分析用户行为和视频内容，提供个性化的视频推荐。平台还为创作者提供AI驱动的分析工具和优化建议，帮助提升内容质量和观众参与度。',
    users: '26亿+',
    accuracy: '76%',
    dailyActive: '20亿+',
    contentSize: '数十亿小时视频',
